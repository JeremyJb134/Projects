...
private:
    ...
    void postOrder(Node *aHeap);
    void preOrder(Node*& aHeap, const Node *rhs);
    Node* mergeRecur(Node*& leftHeap, Node*& rightHeap);
    void recalculateNPL(Node*& aHeap);
    void preOrderPrint(Node* aHeap) const;
    /******************************************

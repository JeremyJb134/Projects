...
//**Constants for Zebra and Lead Balloon**
const int HEALTH_LEAD = 1;
const int HEALTH_ZEBRA = 1;
const int HEALTH_AFTER = 10;
const int LEAD_DAMAGE = 11;
const int ZEBRA_DAMAGE = 21;

...
int main(){
    ...
    Random altGen(0,3);     // there are 4 altitudes
    {
        ...
        int tempID = 0;
        int ID = 0;
        //int array[] = {10005,10007,10002,10006,10008,10000,10003,10009,10001,10010};
        for(int i=0;i<10;i++){
            ID = idGen.getRandNum();
        ...
        if(network.findSatellite(tempID)){
        ...
        cout << "Number of 53 degrees: " << network.countSatellites(I53); 
        ...
        if(network.findSatellite(tempID))
            ...
            cout << "false" << endl;
        network.setState(77392, DEORBITED);
        network.listSatellites();
        cout << endl; 
